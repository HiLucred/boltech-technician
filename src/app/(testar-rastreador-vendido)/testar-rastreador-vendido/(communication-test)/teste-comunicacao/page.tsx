...
export default function CommunicationTest() {
  ...
  return (
    <form className="flex w-full flex-col bg-green-100 px-4 pb-48 pt-8">
      ...
      <AlertDialog
        title="Placa: ABC-1234 | Rastreador: BT123456"
        description="Tem certeza de que deseja confirmar? Esta ação não pode ser desfeita."
        onConfirm={() => router.push("/testar-rastreador-vendido/teste-comunicacao/fotos")}
      />
    </form>
  )
}